...
var help = (function () {
  ...
  var never$1 = $_b208yxaqjf3ft1ip.never;
  var always$1 = $_b208yxaqjf3ft1ip.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_b208yxaqjf3ft1ip.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_dfx902asjf3ft1is = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_5zc6iaojf3ft1i8.map($_dfx902asjf3ft1is.shortcuts, function (shortcut) {
  ...
  var $_2m7kc4anjf3ft1hu = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_1jioowaxjf3ft1jc.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_1jioowaxjf3ft1jc.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_1jioowaxjf3ft1jc.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_1jioowaxjf3ft1jc.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_ebqztwayjf3ft1jg.head(str).bind(function (head) {
      return $_ebqztwayjf3ft1jg.tail(str).map(function (tail) {
  ...
  var $_4bbzx0azjf3ft1jl = { urls: urls };

  var makeLink = $_b208yxaqjf3ft1ip.curry($_98bbsdawjf3ft1j9.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_5zc6iaojf3ft1i8.find($_4bbzx0azjf3ft1jl.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_es8bggavjf3ft1j3.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_5zc6iaojf3ft1i8.filter(keys, $_b208yxaqjf3ft1ip.not($_b208yxaqjf3ft1ip.curry($_5zc6iaojf3ft1i8.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_5zc6iaojf3ft1i8.map(pluginKeys, function (key) {
  ...
  var $_25mk1paujf3ft1iv = { makeTab: makeTab$1 };
  ...
  var $_46t7tvb0jf3ft1jp = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_2m7kc4anjf3ft1hu.makeTab(),
          $_25mk1paujf3ft1iv.makeTab(editor)
        ],
        buttons: $_46t7tvb0jf3ft1jp.makeRow(),
  ...
  var $_6qhlkiamjf3ft1ht = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_6qhlkiamjf3ft1ht.open(editor, pluginUrl));
  };
  var $_6jxsnaljf3ft1hr = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_6qhlkiamjf3ft1ht.open(editor, pluginUrl)
    });
  ...
  var $_bgfaiyb2jf3ft1jr = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_bgfaiyb2jf3ft1jr.register(editor, pluginUrl);
    $_6jxsnaljf3ft1hr.register(editor, pluginUrl);
