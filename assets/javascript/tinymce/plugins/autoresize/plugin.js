...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_8vj28z8cjf3ft13u.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_8vj28z8cjf3ft13u.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_8vj28z8cjf3ft13u.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_8vj28z8cjf3ft13u.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_8vj28z8cjf3ft13u.getAutoResizeBottomMargin(editor);
    ...
    if ($_8vj28z8cjf3ft13u.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_ghfuj89jf3ft13k.resize(editor, oldSize);
    });
  };
  var $_4nrvqk88jf3ft13i = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_4nrvqk88jf3ft13i.register(editor, oldSize);
      $_ghfuj89jf3ft13k.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
