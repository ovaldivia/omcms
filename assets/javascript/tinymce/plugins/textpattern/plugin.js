...
var textpattern = (function () {
  ...
  var $_d33o8uqhjf3ft59n = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_8z5on8qpjf3ft5ae.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_8z5on8qpjf3ft5ae.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_8z5on8qpjf3ft5ae.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_f8hgbqmjf3ft5a4.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_f8hgbqmjf3ft5a4.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_f8hgbqmjf3ft5a4.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !VK.modifierPressed(e)) {
        $_1nc9amqljf3ft59v.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_1nc9amqljf3ft59v.checkKeyCode(keyCodes, e)) {
        $_1nc9amqljf3ft59v.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_1nc9amqljf3ft59v.checkCharCode(charCodes, e)) {
  ...
  var $_5k1irxqijf3ft59p = { setup: setup };

  PluginManager.add('textpattern', function (editor) {
    var patternsState = Cell($_d33o8uqhjf3ft59n.getPatterns(editor.settings));
    $_5k1irxqijf3ft59p.setup(editor, patternsState);
    return $_4k7eotqgjf3ft59d.get(patternsState);
  });
  function Plugin () {
  }
