...
var contextmenu = (function () {
  ...
  var $_7gr6wma2jf3ft1g0 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_ejga5wa1jf3ft1fx.getContextMenu(editor);
  ...
  var $_1tv24aa5jf3ft1g8 = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_ejga5wa1jf3ft1fx.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_1tv24aa5jf3ft1g8.show(editor, $_7gr6wma2jf3ft1g0.getPos(editor, e), visibleState, menu);
    });
  };
  var $_6cakeia0jf3ft1fw = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_6cakeia0jf3ft1fw.setup(editor, visibleState, menu);
    return $_bhpy69zjf3ft1fu.get(visibleState);
  });
  function Plugin () {
  }
