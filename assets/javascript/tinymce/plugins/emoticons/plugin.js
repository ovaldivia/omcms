...
var emoticons = (function () {
  ...
  var $_ciae7dahjf3ft1hg = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_ciae7dahjf3ft1hg.getHtml(pluginUrl);
  ...
  var $_6jk15sagjf3ft1he = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_6jk15sagjf3ft1he.register(editor, pluginUrl);
  });
  function Plugin () {
  }
