...
var wordcount = (function () {
  ...
  var $_5skwoms4jf3ft5ip = {
    each: each,
    map: map
  };

  var SETS$1 = $_9vazxks2jf3ft5ih.SETS;
  var OTHER = $_9vazxks2jf3ft5ih.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_5skwoms4jf3ft5ip.map(string.split(''), memoized);
  };
  var $_4eocsls3jf3ft5in = { classify: classify };

  var ci = $_9vazxks2jf3ft5ih.characterIndices;
  ...
  var $_frnsdos5jf3ft5is = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_9vazxks2jf3ft5ih.EMPTY_STRING;
  var WHITESPACE$1 = $_9vazxks2jf3ft5ih.WHITESPACE;
  var PUNCTUATION$1 = $_9vazxks2jf3ft5ih.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_4eocsls3jf3ft5in.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_frnsdos5jf3ft5is.isWordBoundary(map, i)) {
  ...
  var $_5kq07ls1jf3ft5id = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_5kq07ls1jf3ft5id.getWords(getTextContent(editor)).length;
  };
  var $_f39evls0jf3ft5ib = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_f39evls0jf3ft5ib.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_1g3ncnrzjf3ft5i9 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_f39evls0jf3ft5ib.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_a10he3s6jf3ft5iv = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_a10he3s6jf3ft5iv.setup(editor);
    return $_1g3ncnrzjf3ft5i9.get(editor);
  });
  function Plugin () {
  }
