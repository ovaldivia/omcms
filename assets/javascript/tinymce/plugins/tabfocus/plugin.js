...
var tabfocus = (function () {
  ...
  var $_9iz7k9jmjf3ft32h = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_9iz7k9jmjf3ft32h.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_b8p5xijfjf3ft32c = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_b8p5xijfjf3ft32c.setup(editor);
  });
  function Plugin () {
  }
