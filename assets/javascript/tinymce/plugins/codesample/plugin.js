...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_1at9hg9njf3ft1d3.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_25eu179jjf3ft1a1.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_bi30v9ljf3ft1a3.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_62q5gf9ojf3ft1d6 = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_3ppprn9ijf3ft19z = {
    open: function (editor) {
      var minWidth = $_25eu179jjf3ft1a1.getDialogMinWidth(editor);
      var minHeight = $_25eu179jjf3ft1a1.getDialogMinHeight(editor);
      var currentLanguage = $_62q5gf9ojf3ft1d6.getCurrentLanguage(editor);
      var currentLanguages = $_62q5gf9ojf3ft1d6.getLanguages(editor);
      var currentCode = $_bi30v9ljf3ft1a3.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_bi30v9ljf3ft1a3.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_1at9hg9njf3ft1d3.isCodeSample(node)) {
        $_3ppprn9ijf3ft19z.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_8y14999hjf3ft19x = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_1at9hg9njf3ft1d3.trimArg($_1at9hg9njf3ft1d3.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_1at9hg9njf3ft1d3.trimArg($_1at9hg9njf3ft1d3.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_7uckiw9pjf3ft1d9 = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_25eu179jjf3ft1a1.getContentCss(editor);
  ...
  var $_e5y1wz9qjf3ft1db = { loadCss: loadCss };
  ...
  var $_3s1lv29rjf3ft1dd = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_7uckiw9pjf3ft1d9.setup(editor);
    $_3s1lv29rjf3ft1dd.register(editor);
    $_8y14999hjf3ft19x.register(editor);
    editor.on('init', function () {
      $_e5y1wz9qjf3ft1db.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_1at9hg9njf3ft1d3.isCodeSample(ev.target)) {
        $_3ppprn9ijf3ft19z.open(editor);
      }
    });
  });
