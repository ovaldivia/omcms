...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_9p44z1e5jf3ft25s.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_9p44z1e5jf3ft25s.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_9p44z1e5jf3ft25s.getSelectorConverter(editor)) {
      selectorConverter = $_9p44z1e5jf3ft25s.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_9p44z1e5jf3ft25s.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_9p44z1e5jf3ft25s.getCssGroups(editor));
      ...
      if (!$_9p44z1e5jf3ft25s.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_9p44z1e5jf3ft25s.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_cgeb7te0jf3ft25b.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_frnaa4dzjf3ft256 = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_cgeb7te0jf3ft25b.setup(editor);
    return $_frnaa4dzjf3ft256.get(editor);
  });
  function Plugin () {
  }
