...
var inlite = (function () {
  ...
  var $_ddxlyl16ijf3ft9x9 = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_7qroue16mjf3ft9xo.fromClientRect(clientRect)) : null;
  };
  var $_5k9ohq16ljf3ft9xj = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_6co8gu16kjf3ft9xh.result(predicateIds[i].id, $_5k9ohq16ljf3ft9xj.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_6co8gu16kjf3ft9xh.result(predicateIds[x].id, $_5k9ohq16ljf3ft9xj.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_6co8gu16kjf3ft9xh.result(id, $_5k9ohq16ljf3ft9xj.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_6co8gu16kjf3ft9xh.result(id, $_5k9ohq16ljf3ft9xj.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_emx50e16vjf3ft9yn.isArray(value)) {
      return value;
    } else if ($_emx50e16vjf3ft9yn.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_emx50e16vjf3ft9yn.isBoolean(value)) {
  ...
  var $_d8q7hf16ujf3ft9yi = {
    getStringOr: getByTypeOr($_emx50e16vjf3ft9yn.isString),
    getBoolOr: getByTypeOr($_emx50e16vjf3ft9yn.isBoolean),
    getNumberOr: getByTypeOr($_emx50e16vjf3ft9yn.isNumber),
    getHandlerOr: getByTypeOr($_emx50e16vjf3ft9yn.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_emx50e16vjf3ft9yn.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_7qroue16mjf3ft9xo.toClientRect(targetRect),
        contentAreaRect: $_7qroue16mjf3ft9xo.toClientRect(contentAreaRect),
        panelRect: $_7qroue16mjf3ft9xo.toClientRect(panelRect)
      });
      return $_7qroue16mjf3ft9xo.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_d8q7hf16ujf3ft9yi.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_d8q7hf16ujf3ft9yi.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_d8q7hf16ujf3ft9yi.getHandlerOr(editor, 'inline_toolbar_position_handler', $_6o1ryo16wjf3ft9ys.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_19qs6e16rjf3ft9y8.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_epqtfp16sjf3ft9yc.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_epqtfp16sjf3ft9yc.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_1c41ug16qjf3ft9y0 = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_ddxlyl16ijf3ft9x9.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_7skhip16njf3ft9xr.fromContextToolbars(toolbars);
    result = $_6co8gu16kjf3ft9xh.match(editor, [
      $_dzt23416jjf3ft9xd.element(elements[0], contextToolbarsPredicateIds),
      $_bmwogu16pjf3ft9xu.textSelection('text'),
      $_bmwogu16pjf3ft9xu.emptyTextBlock(elements, 'insert'),
      $_dzt23416jjf3ft9xd.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_6co8gu16kjf3ft9xh.match(editor, [$_bmwogu16pjf3ft9xu.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_1c41ug16qjf3ft9y0.load(editor, function () {
  ...
  var $_5go5yg16ejf3ft9wz = { renderUI: renderUI };
  ...
  var never$1 = $_1469mf171jf3fta46.never;
  var always$1 = $_1469mf171jf3fta46.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_1469mf171jf3fta46.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_d0dxk8178jf3fta5m.parseBox(settings.border);
      self.paddingBox = $_d0dxk8178jf3fta5m.parseBox(settings.padding);
      self.marginBox = $_d0dxk8178jf3fta5m.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_8oglir17gjf3fta6a.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_d0dxk8178jf3fta5m.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_d0dxk8178jf3fta5m.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_d0dxk8178jf3fta5m.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_b2wnfn17fjf3fta67.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_8oglir17gjf3fta6a.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_8oglir17gjf3fta6a.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_3cg49b17hjf3fta6f = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_8oglir17gjf3fta6a.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_8oglir17gjf3fta6a.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_3jwtlg16zjf3fta07.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_3jwtlg16zjf3fta07.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_d0dxk8178jf3fta5m.parseBox(self.settings.border);
          ...
          self.borderBox = $_d0dxk8178jf3fta5m.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_5go5yg16ejf3ft9wz.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_1rqnn716djf3ft9ws = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_x42rw180jf3fta9c.resolve(name, scope);
  };
  ...
  var $_6vg7fr17zjf3fta99 = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_6vg7fr17zjf3fta99.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_8iotqj17xjf3fta93 = { blobToBase64: blobToBase64 };
  ...
  var $_2l36qc183jf3fta9g = { pickFile: pickFile };
  ...
  var $_53s51b185jf3fta9n = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_fx8lv7187jf3fta9s.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_fx8lv7187jf3fta9s.resolve(dom, bookmark));
  };
  ...
  var $_3ehrsk186jf3fta9p = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_53s51b185jf3fta9n.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_3ehrsk186jf3fta9p.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_fm6xcg184jf3fta9j.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_2l36qc183jf3fta9g.pickFile().then(function (files) {
          var blob = files[0];
          $_8iotqj17xjf3fta93.blobToBase64(blob).then(function (base64) {
            $_fm6xcg184jf3fta9j.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_fm6xcg184jf3fta9j.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_1r6hs917wjf3fta90 = { addToEditor: addToEditor };
  ...
  var $_dzlgi818bjf3ftaa1 = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_22rlh818djf3ftaa7.isAbsolute(href) && $_22rlh818djf3ftaa7.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_fm6xcg184jf3fta9j.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_fm6xcg184jf3fta9j.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_bjofvn18cjf3ftaa5 = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_emx50e16vjf3ft9yn.isArray(items)) {
      return items;
    } else if ($_emx50e16vjf3ft9yn.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    Tools.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_emx50e16vjf3ft9yn.isFunction(button)) {
            button = button();
          }
  ...
  var $_3d2hnl18ejf3ftaa9 = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_3d2hnl18ejf3ftaa9.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_3d2hnl18ejf3ftaa9.create(editor, 'text', $_epqtfp16sjf3ft9yc.getTextSelectionToolbarItems(editor)),
        $_3d2hnl18ejf3ftaa9.create(editor, 'insert', $_epqtfp16sjf3ft9yc.getInsertToolbarItems(editor)),
        $_bjofvn18cjf3ftaa5.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_epqtfp16sjf3ft9yc.getPositionHandler(editor);
      contentAreaRect = $_5k9ohq16ljf3ft9xj.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_6o1ryo16wjf3ft9ys.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_6o1ryo16wjf3ft9ys.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_dzlgi818bjf3ftaa1.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_6o1ryo16wjf3ft9ys.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_5k9ohq16ljf3ft9xj.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_6o1ryo16wjf3ft9ys.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_6o1ryo16wjf3ft9ys.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_19qs6e16rjf3ft9y8.fireBeforeRenderUI(editor);
  ...
  var $_8tes92191jf3ftacy = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_1469mf171jf3fta46.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_dtsxr3192jf3ftad0 = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_d6xllq196jf3ftadf = { cached: cached };

  var $_1a0zc3198jf3ftadi = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_1a0zc3198jf3ftadi.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_1a0zc3198jf3ftadi.ELEMENT);
  var isText = isType$1($_1a0zc3198jf3ftadi.TEXT);
  var isDocument = isType$1($_1a0zc3198jf3ftadi.DOCUMENT);
  var $_901htp197jf3ftadh = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_901htp197jf3ftadh.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_d6xllq196jf3ftadf.cached(function () {
    return getBody($_dtsxr3192jf3ftad0.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_dtsxr3192jf3ftad0.fromDom(body);
  };
  var $_90k7ck195jf3ftadb = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_3jwtlg16zjf3fta07.each(fields, function (name, i) {
        struct[name] = $_1469mf171jf3fta46.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_94eyzx19ajf3ftae9.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_3jwtlg16zjf3fta07.each(array, function (a) {
      if (!$_94eyzx19ajf3ftae9.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_3jwtlg16zjf3fta07.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_12ranb19fjf3ftaeh.validateStrArr('required', required);
    $_12ranb19fjf3ftaeh.validateStrArr('optional', optional);
    $_12ranb19fjf3ftaeh.checkDupes(everything);
    return function (obj) {
      var keys = $_62qdnx19ejf3ftaee.keys(obj);
      var allReqd = $_3jwtlg16zjf3fta07.forall(required, function (req) {
        return $_3jwtlg16zjf3fta07.contains(keys, req);
      });
      if (!allReqd)
        $_12ranb19fjf3ftaeh.reqMessage(required, keys);
      var unsupported = $_3jwtlg16zjf3fta07.filter(keys, function (key) {
        return !$_3jwtlg16zjf3fta07.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_12ranb19fjf3ftaeh.unsuppMessage(unsupported);
      var r = {};
      $_3jwtlg16zjf3fta07.each(required, function (req) {
        r[req] = $_1469mf171jf3fta46.constant(obj[req]);
      });
      $_3jwtlg16zjf3fta07.each(optional, function (opt) {
        r[opt] = $_1469mf171jf3fta46.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_1xtja19bjf3ftaea = {
    immutable: Immutable,
  ...
  var $_d7xuyf19gjf3ftaek = { toArray: toArray };

  var node = function () {
    var f = $_6vg7fr17zjf3fta99.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_4lshn619mjf3ftaf8.unknown()
    });
  };
  ...
  var $_1gfrrf19ljf3ftaf4 = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_1469mf171jf3fta46.constant(edge),
    chrome: $_1469mf171jf3fta46.constant(chrome),
    ie: $_1469mf171jf3fta46.constant(ie),
    opera: $_1469mf171jf3fta46.constant(opera),
    firefox: $_1469mf171jf3fta46.constant(firefox),
    safari: $_1469mf171jf3fta46.constant(safari)
  };
  ...
  var $_9egpie19njf3ftafb = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_1469mf171jf3fta46.constant(windows$1),
    ios: $_1469mf171jf3fta46.constant(ios),
    android: $_1469mf171jf3fta46.constant(android),
    linux: $_1469mf171jf3fta46.constant(linux),
    osx: $_1469mf171jf3fta46.constant(osx),
    solaris: $_1469mf171jf3fta46.constant(solaris),
    freebsd: $_1469mf171jf3fta46.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_1469mf171jf3fta46.constant(isiPad),
      isiPhone: $_1469mf171jf3fta46.constant(isiPhone),
      isTablet: $_1469mf171jf3fta46.constant(isTablet),
      isPhone: $_1469mf171jf3fta46.constant(isPhone),
      isTouch: $_1469mf171jf3fta46.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_1469mf171jf3fta46.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_3jwtlg16zjf3fta07.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_4lshn619mjf3ftaf8.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_4lshn619mjf3ftaf8.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_818f2619sjf3ftafs.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_818f2619sjf3ftafs.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_818f2619sjf3ftafs.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_818f2619sjf3ftafs.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_68uyvy19tjf3ftaft.head(str).bind(function (head) {
      return $_68uyvy19tjf3ftaft.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_3itso319rjf3ftafq.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_3itso319rjf3ftafq.contains(uastring, 'edge/') && $_3itso319rjf3ftafq.contains(uastring, 'chrome') && $_3itso319rjf3ftafq.contains(uastring, 'safari') && $_3itso319rjf3ftafq.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_3itso319rjf3ftafq.contains(uastring, 'chrome') && !$_3itso319rjf3ftafq.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_3itso319rjf3ftafq.contains(uastring, 'msie') || $_3itso319rjf3ftafq.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_3itso319rjf3ftafq.contains(uastring, 'safari') || $_3itso319rjf3ftafq.contains(uastring, 'mobile/')) && $_3itso319rjf3ftafq.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_3itso319rjf3ftafq.contains(uastring, 'iphone') || $_3itso319rjf3ftafq.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_74xiq719qjf3ftafl = {
    browsers: $_1469mf171jf3fta46.constant(browsers),
    oses: $_1469mf171jf3fta46.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_74xiq719qjf3ftafl.browsers();
    var oses = $_74xiq719qjf3ftafl.oses();
    var browser = $_a8ln2c19pjf3ftafi.detectBrowser(browsers, userAgent).fold($_1gfrrf19ljf3ftaf4.unknown, $_1gfrrf19ljf3ftaf4.nu);
    var os = $_a8ln2c19pjf3ftafi.detectOs(oses, userAgent).fold($_9egpie19njf3ftafb.unknown, $_9egpie19njf3ftafb.nu);
  ...
  var $_3ddcan19kjf3ftaf2 = { detect: detect$2 };

  var detect$3 = $_d6xllq196jf3ftadf.cached(function () {
    var userAgent = navigator.userAgent;
    return $_3ddcan19kjf3ftaf2.detect(userAgent);
  });
  var $_dga6up19jjf3ftaez = { detect: detect$3 };

  var ELEMENT = $_1a0zc3198jf3ftadi.ELEMENT;
  var DOCUMENT = $_1a0zc3198jf3ftadi.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_3jwtlg16zjf3fta07.map(base.querySelectorAll(selector), $_dtsxr3192jf3ftad0.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_dtsxr3192jf3ftad0.fromDom);
  };
  var $_23k92819ujf3ftafv = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_3jwtlg16zjf3fta07.exists(elements, $_1469mf171jf3fta46.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_4qnnk219ijf3ftaex.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_dga6up19jjf3ftaez.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_erto119hjf3ftaem = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_23k92819ujf3ftafv.is
  };

  var owner = function (element) {
    return $_dtsxr3192jf3ftad0.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_dtsxr3192jf3ftad0.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_dtsxr3192jf3ftad0.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_dtsxr3192jf3ftad0.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_3jwtlg16zjf3fta07.findIndex(kin, function (elem) {
        return $_erto119hjf3ftaem.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_94eyzx19ajf3ftae9.isFunction(isRoot) ? isRoot : $_1469mf171jf3fta46.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_dtsxr3192jf3ftad0.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_3jwtlg16zjf3fta07.filter(elements, function (x) {
        return !$_erto119hjf3ftaem.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_dtsxr3192jf3ftad0.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_dtsxr3192jf3ftad0.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_dtsxr3192jf3ftad0.fromDom);
  };
  var prevSiblings = function (element) {
    return $_3jwtlg16zjf3fta07.reverse($_d7xuyf19gjf3ftaek.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_d7xuyf19gjf3ftaek.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_3jwtlg16zjf3fta07.map(dom.childNodes, $_dtsxr3192jf3ftad0.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_dtsxr3192jf3ftad0.fromDom);
  };
  ...
  var spot = $_1xtja19bjf3ftaea.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_907c29199jf3ftady = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_90k7ck195jf3ftadb.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_3jwtlg16zjf3fta07.filter($_907c29199jf3ftady.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_3jwtlg16zjf3fta07.filter($_907c29199jf3ftady.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_3jwtlg16zjf3fta07.filter($_907c29199jf3ftady.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_3jwtlg16zjf3fta07.each($_907c29199jf3ftady.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_23k92819ujf3ftafv.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_1k5a5x194jf3ftad7.ancestors(scope, function (e) {
      return $_23k92819ujf3ftafv.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_1k5a5x194jf3ftad7.siblings(scope, function (e) {
      return $_23k92819ujf3ftafv.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_1k5a5x194jf3ftad7.children(scope, function (e) {
      return $_23k92819ujf3ftafv.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_23k92819ujf3ftafv.all(selector, scope);
  };
  var $_59umxi193jf3ftad5 = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_3jwtlg16zjf3fta07.map($_59umxi193jf3ftad5.descendants($_dtsxr3192jf3ftad0.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_8tes92191jf3ftacy.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_1469mf171jf3fta46.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_3jwtlg16zjf3fta07.map($_3jwtlg16zjf3fta07.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_3jwtlg16zjf3fta07.map($_3jwtlg16zjf3fta07.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_3jwtlg16zjf3fta07.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_1zvjft190jf3ftacr = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_1469mf171jf3fta46.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_3jwtlg16zjf3fta07.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_3jwtlg16zjf3fta07.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_3jwtlg16zjf3fta07.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_3jwtlg16zjf3fta07.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_3jwtlg16zjf3fta07.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_1zvjft190jf3ftacr.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_94eyzx19ajf3ftae9.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_90k7ck195jf3ftadb.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_dtsxr3192jf3ftad0.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_dtsxr3192jf3ftad0.fromDom(element.parentNode), function (x) {
      return !$_erto119hjf3ftaem.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_3jwtlg16zjf3fta07.find(scope.dom().childNodes, $_1469mf171jf3fta46.compose(predicate, $_dtsxr3192jf3ftad0.fromDom));
    return result.map($_dtsxr3192jf3ftad0.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_dtsxr3192jf3ftad0.fromDom(element.childNodes[i])))
          return Option.some($_dtsxr3192jf3ftad0.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_23k92819ujf3ftafv.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_22bbl51a0jf3ftagy.ancestor(scope, function (e) {
      return $_23k92819ujf3ftafv.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_22bbl51a0jf3ftagy.sibling(scope, function (e) {
      return $_23k92819ujf3ftafv.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_22bbl51a0jf3ftagy.child(scope, function (e) {
      return $_23k92819ujf3ftafv.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_23k92819ujf3ftafv.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_23k92819ujf3ftafv.is, ancestor$1, scope, selector, isRoot);
  };
  var $_d0vzcc19zjf3ftagw = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_64lgrj1a3jf3ftahb.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_64lgrj1a3jf3ftahb.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_64lgrj1a3jf3ftahb.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_64lgrj1a3jf3ftahb.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_64lgrj1a3jf3ftahb.postRenderFormat(editor, name)
      });
    });
  };
  var $_2pzdh51a2jf3ftah9 = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_dtsxr3192jf3ftad0.fromDom).filter($_901htp197jf3ftadh.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_dm7gef1a5jf3ftahh = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_1469mf171jf3fta46.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_dm7gef1a5jf3ftahh.getFontFamily(editor.getBody(), e.element);
  ...
  var $_5fcuvj1a4jf3ftahd = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_dm7gef1a5jf3ftahh.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_dm7gef1a5jf3ftahh.toPt(px, precision);
  ...
  var $_7murzp1a6jf3ftahp = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_64lgrj1a3jf3ftahb.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_e6gpxp1a7jf3ftahu = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_64lgrj1a3jf3ftahb.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_64lgrj1a3jf3ftahb.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_bec5kk1a8jf3ftai1 = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_3jwtlg16zjf3fta07.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_3jwtlg16zjf3fta07.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_3jwtlg16zjf3fta07.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_9pyns61a9jf3ftai7 = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_64lgrj1a3jf3ftahb.postRenderFormat(editor, name),
        onclick: $_64lgrj1a3jf3ftahb.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_64lgrj1a3jf3ftahb.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_3dtx561aajf3ftaic = { register: register$6 };
  ...
  var $_dhxxh61abjf3ftaif = { register: register$7 };
  ...
  var $_76788c1acjf3ftaih = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_d0vzcc19zjf3ftagw.descendant($_dtsxr3192jf3ftad0.fromDom(document.body), editor.settings.ui_container).fold($_1469mf171jf3fta46.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_bec5kk1a8jf3ftai1.register(editor);
    $_2pzdh51a2jf3ftah9.register(editor);
    $_3dtx561aajf3ftaic.register(editor);
    $_dhxxh61abjf3ftaif.register(editor);
    $_7murzp1a6jf3ftahp.register(editor);
    $_5fcuvj1a4jf3ftahd.register(editor);
    $_e6gpxp1a7jf3ftahu.register(editor);
    $_76788c1acjf3ftaih.register(editor);
    $_9pyns61a9jf3ftai7.register(editor);
  };
  var $_4b7xzb19yjf3ftagq = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_94eyzx19ajf3ftae9.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_94eyzx19ajf3ftae9.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_b2wnfn17fjf3fta67,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_db9kmb17tjf3fta8e,
      Panel: Panel,
      Movable: $_3cg49b17hjf3fta6f,
      Resizable: $_3mni6i17ujf3fta8j,
      ...
      FormatControls: $_4b7xzb19yjf3ftagq,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = create$3();
    $_4b7xzb19yjf3ftagq.setup(editor);
    $_1r6hs917wjf3fta90.addToEditor(editor, panel);
    return $_1rqnn716djf3ft9ws.get(editor, panel);
  });
  function Theme () {
  }
